...
const CreateMedicineModal = ({ open, onClose }) => {
  const [medicine, setMedicine] = useState({
    userId: getDataJSONStorage(USER_LOGIN).UserId,
    name: "",
    dosage: "",
    frequency: "",
    srcImg: "",
  ...
  const handleSubmit = () => {
    run(CreateMedicineActionAsync(medicine), () => {
        onClose();
        setMedicine({
          userId: getDataJSONStorage(USER_LOGIN).UserId,
          name: "",
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          Please fill in the detailed information about the medicine
        </Typography>
